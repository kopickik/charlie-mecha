...
<div id="page">
  ...
  <header class="navbar navbar-fixed-top clearfix" id="header" role="banner">
    <div class="container">
    <div class="row">
    ...
    <?php if ($site_name || $site_slogan): ?>
      <div class="col-md-4 header__name-and-slogan" id="name-and-slogan">
        <?php if ($site_name): ?>
    ...
    <div id="navigation" class="col-md-6 col-sm-12">
